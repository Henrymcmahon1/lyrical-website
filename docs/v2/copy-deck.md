...
Rules: lowercase `lyrical`. US spelling. No em dashes. Never "AI-generated". Say re-sung, recreated, performed. Bots B, C and D use these strings verbatim; a change here is Henry's call.
